...
namespace WebApi.Controllers
{
    ...
    public class LoginController : ControllerBase, IDisposable
    {
        ...
        public IActionResult Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            AccessTokenConfig tokenConfig = HttpContext.RequestServices.GetRequiredService<AccessTokenConfig>();
            var tokenString = AccessTokenHelper.WriteToken(sessionID.ToString(), user, tokenConfig);            
